...
maria/
  ...
  maria_core/              # Legacy (stary kod; live path importuje bezposrednio)
...
| ADR-029 | GitHub = publiczna wizytowka, nie live mirror produkcji |
| ADR-030 | Skills as artifact (Hermes-inspired procedural memory, sandbox-first promote z human gate) |
